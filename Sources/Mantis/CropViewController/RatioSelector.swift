...
public class RatioSelector: UIView {
    ...
    public var originalRatioH: Double = 0.0
    ...
    public init(type: RatioType, originalRatioH: Double, ratios: [RatioItemType] = []) {
    ...
    public func update(fixedRatioManager: FixedRatioManager?) {
